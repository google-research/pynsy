...
# train_label: [60000, 784]
# train_label: [60000, 10]
train_images, train_labels, test_images, test_labels = datasets.mnist()
shaper.annotate_shape(train_images, ("example_count", "784"))
print('train_images', train_images.shape)
print('train_labels', train_labels.shape)
print('test_images', train_images.shape)
print('test_labels', train_labels.shape)
...
def init_random_params(scale, layer_sizes, rng):
  return [
...
def main():
  ...
  params = init_random_params(param_scale, layer_sizes, rng)
  batches = data_generator(rng)

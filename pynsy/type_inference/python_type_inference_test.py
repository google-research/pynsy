...
class MyTestCase(unittest.TestCase):
  ...
  def test_list_empty(self):
    t = abstraction([])
    print(t)
    self.assertEqual(str(t), "(True, list[Any])")

  def test_list_int(self):
    t = abstraction([1, 2, 3])
    print(t)
    self.assertEqual(str(t), "(True, list[int])")

  def test_list_two(self):
    t = abstraction([1, "a", 2, "b"])
    print(t)
    self.assertEqual(str(t), "(True, list[Union[int, str]])")
  ...
  def test_tuple_empty(self):
    t = abstraction(())
    print(t)
    self.assertEqual(str(t), "(True, tuple[Any])")

  def test_tuple_int(self):
    t = abstraction((1, 2, 3))
    print(t)
    self.assertEqual(str(t), "(True, tuple[int,...])")

  def test_tuple_two(self):
    t = abstraction((1, "a", 2, "b"))
    print(t)
    self.assertEqual(str(t), "(True, tuple[int, str, int, str])")

  def test_tuple_three(self):
    t = abstraction((1, "a", 2, "b", 3, A()))
    print(t)
    self.assertEqual(str(t), "(True, tuple[int, str, int, str, int, A])")

  def test_set_empty(self):
    t = abstraction(set())
    print(t)
    self.assertEqual(str(t), "(True, set[Any])")

  def test_set_float(self):
    t = abstraction({1.0, 2.0, 3.0})
    print(t)
    self.assertEqual(str(t), "(True, set[float])")

  def test_set_two(self):
    t = abstraction({1, "a", 2, "b"})
    print(t)
    self.assertEqual(str(t), "(True, set[Union[int, str]])")
  ...
  def test_dict_empty(self):
    t = abstraction({})
    print(t)
    self.assertEqual(str(t), "(True, dict[Any, Any])")

  def test_dict_one(self):
    t = abstraction({"head": 5})
    print(t)
    self.assertEqual(str(t), "(True, dict[str, int])")
